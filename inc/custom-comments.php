...
// Comments form.
add_filter( 'comment_form_default_fields', 'diana_simple_bootstrap_comment_form_fields' );
...
if ( ! function_exists( 'diana_simple_bootstrap_comment_form_fields' ) ) {

	function diana_simple_bootstrap_comment_form_fields( $fields ) {
...
} // endif function_exists( 'diana_simple_bootstrap_comment_form_fields' )

add_filter( 'comment_form_defaults', 'diana_simple_bootstrap_comment_form' );
...
if ( ! function_exists( 'diana_simple_bootstrap_comment_form' ) ) {
...
} // endif function_exists( 'diana_simple_bootstrap_comment_form' )
