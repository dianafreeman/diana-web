...
function diana_simple_theme_scripts() {
	...
	if (is_home()){
		wp_enqueue_script( 'front-header-js', get_stylesheet_directory_uri() . '/assets/js/homePage.min.js', array('jquery','typed-js'), '', true );
	} else {
		wp_enqueue_script( 'page-header-js', get_stylesheet_directory_uri() . '/assets/js/page.min.js', array('jquery','typed-js'), '', true );
