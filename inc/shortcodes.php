...
function solid_social(){
  ...
  <a role="button" aria-label="Link to Find Me on Twitter" class="social-link-twitter solid" target="_blank" href="'.esc_url( "https://twtitter.com/dianasfreeman" ).'" role="button">
    <i class="fab fa-twitter"></i>
  </a>
  <a role="button" aria-label="Link to Find Me on LinkedIn" class="social-link-linkedin solid" target="_blank" href="'.esc_url( "https://www.linkedin.com/in/dianasteakleyfreeman/" ).'"  role="button">
    <i class="fab fa-linkedin"></i>
  </a>
  <a role="button" aria-label="Link to Find Me on Medium " class="social-link-medium solid" target="_blank" href="'.esc_url( "https://medium.com/@dsteakleyfreeman" ).'" role="button">
    <i class="fab fa-medium"></i>
  </a>
  <a role="button" aria-label="Link to Find Me on Github " class="social-link-github solid" target="_blank" href="'.esc_url( "https://github.com/dianafreeman" ).'" role="button">
