 ...
 */
add_filter( 'dynamic_sidebar_params', 'diana_simple_widget_classes' );

if ( ! function_exists( 'diana_simple_widget_classes' ) ) {
	/**
	 ...
	 * @return array $params
	 */
	function diana_simple_widget_classes( $params ) {
...
} // endif function_exists( 'diana_simple_widget_classes' ).

add_action( 'widgets_init', 'diana_simple_widgets_init' );

if ( ! function_exists( 'diana_simple_widgets_init' ) ) {
	/**
...
} // endif function_exists( 'diana_simple_widgets_init' ).
