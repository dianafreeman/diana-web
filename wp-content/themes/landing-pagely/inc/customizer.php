 ...
 */
function landing_pagely_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( 'toggle_hide_sidebar', array(
        'label'    => __( 'Hide Sidebar', 'landing-pagely' ),
    ...
    $wp_customize->add_control( 'twitter_url', array(
        'label'    => __( "Twitter URL", 'landing-pagely' ),
    ...
    $wp_customize->add_control( 'facebook_url', array(
        'label'    => __( "Facebook URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'soundcloud_url', array(
        'label'    => __( "Soundcloud URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'pinterest_url', array(
        'label'    => __( "Pinterest URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'youtube_url', array(
        'label'    => __( "Youtube URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'social_media_color', array(
        'label'       => __( 'Social Media Icons Color', 'landing-pagely' ),
        'section'     => 'header_image',
        'priority'   => 0,
    ...
    $wp_customize->add_control( 'linkedin_url', array(
        'label'    => __( "LinkedIn URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'twitch_url', array(
        'label'    => __( "Twitch URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'instagram_url', array(
        'label'    => __( "Instagram URL", 'landing-pagely' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'top_header_background_color', array(
        'label'       => __( 'Header Background Color', 'landing-pagely' ),
        'description' => __( 'Applied to header background.', 'landing-pagely' ),
        'section'     => 'header_image',
        'priority'   => 10,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'general_theme_color', array(
        'label'       => __( 'General Theme Color', 'landing-pagely' ),
        'section'     => 'colors',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_frontpage_link_color', array(
        'label'       => __( 'Navigation Link Color', 'landing-pagely' ),
        'section'     => 'colors',
        'priority'   => 1,
    ...
    $wp_customize->add_section( 'sidebars_settings', array(
        'title'      => __('Sidebar','landing-pagely'),
        'priority'   => 100,
        'capability' => 'edit_theme_options',
        ) );

    $wp_customize->add_section( 'landing_pagely_header_settings', array(
        'title'      => __('Header','landing-pagely'),
        'priority'   => 122,
        'capability' => 'edit_theme_options',
        ) );
    $wp_customize->add_section( 'navigation_settings', array(
        'title'      => __('Navigation Settings','landing-pagely'),
        'priority'   => 50,
        'capability' => 'edit_theme_options',
        ) );
...
add_action( 'customize_register', 'landing_pagely_customize_register' );

if(! function_exists('landing_pagely_final_output' ) ):
    function landing_pagely_final_output(){
        ?>
        <style type="text/css">
        ...
        .footer-widgets #pagelyform input[type='submit'],  .footer-widgets #pagelyform input[type='submit']:hover{ background: <?php echo esc_attr(get_theme_mod( 'footer_link_color')); ?>; }
    ...
    <?php }
    add_action( 'wp_head', 'landing_pagely_final_output' );
    endif;

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function landing_pagely_customize_preview_js() {
   wp_enqueue_script( 'landing_pagely_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'landing_pagely_customize_preview_js' );
