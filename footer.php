...
<br><a role="button" tabindex="0"
    ...
    Privacy Policy</a> <br> Proudly Powered by <a class="text-light muted" target="_blank" rel="noopener" href="<?php echo esc_url('https://wordpress.org') ?>">WordPress</a>. Theme by Me. </p>
</div>
</div><!-- wrapper end -->
